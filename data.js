var menu ={
	...
	programming: [
		{url: "computer", label: "< Computer Menu"},
		{url: "assembly", label: "Assembly Menu >"},
		{url: "awk", label: "Awk Menu >"},
		{url: "bash", label: "Bash Menu >"},
		{url: "basic", label: "BASIC Menu >"},
		{url: "c", label: "C Menu >"},
		{url: "challenges", label: "Challenges Menu >"},
		{url: "cpp", label: "Cpp Menu >"},
		{url: "database", label: "Database Menu >"},
		{url: "general", label: "General Menu >"},
		{url: "go", label: "Golang Menu >"},
	...
	assembly: [
		{url: "programming", label: "< Assembly Menu"},
		{url: "http://plit.de/asem-51/", label: "8051 Macro Assembler ASEM-51"},
	],
	awk: [
		{url: "programming", label: "< Programming Menu"},
		{url: "https://github.com/learnbyexample/Command-line-text-processing/blob/master/gnu_awk.md", label: "Learn by Example - Command-line-text-processing"},
	],
	bash: [
		{url: "programming", label: "< Programming Menu"},
		{url: "https://unnikked.ga/scraping-a-subreddit-with-a-one-liner-6322f74134df", label: "Scraping a Subreddit With a One-Liner – unnikked"},
	],
	basic: [
		{url: "programming", label: "< Programming Menu"},
		{url: "https://web.archive.org/web/20100109044357/http://www.o-bizz.de:80/qbtuts/gw-train/index.htm", label: "BASIC TRAINING - A GW-BASIC Tutorial"},
		{url: "https://web.archive.org/web/20091027064142/http://www.geocities.com/KindlyRat/GWCOM.html", label: "GWBASIC"},
	],
	c: [
		{url: "programming", label: "< Programming Menu"},
	...
	cpp: [
		{url: "programming", label: "< Programming Menu"},
		{url: "https://github.com/AnthonyCalandra/modern-cpp-features", label: "A cheatsheet of modern C++ language and library features."},
		{url: "http://en.cppreference.com/w/Main_Page", label: "C++ Reference"},
		{url: "http://www.cplusplus.com/reference/", label: "Standard C++ Reference"},
		{url: "http://theboostcpplibraries.com/", label: "The Boost C++ Libraries"},
		{url: "http://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines", label: "C++ Core Guidelines"},
		{url: "http://www.imagemagick.org/Magick++/", label: "Magick++ API"},
		{url: "http://www.learncpp.com/", label: "Learn C++"},
		{url: "https://cppan.org/", label: "C++ Archive Network"},
		{url: "https://www.airbornos.com/register", label: "Register - Airborn OS"},
		{url: "http://buckaroo.pm/", label: "Buckaroo - C/C++ Package Manager"},
	...
	general: [
		{url: "programming", label: "< Programming Menu"},
		{url: "mostly", label: "A collection of (mostly) technical things every software developer should know"},
		{url: "http://ascii.cl/", label: "ASCII Codes"},
		{url: "http://www.bigocheatsheet.com/", label: "Big-O Algorithm Complexity Cheat Sheet"},
		{url: "http://cbor.io/", label: "CBOR — Concise Binary Object Representation | Overview"},
		{url: "https://character-map.tulz.io/", label: "Character Map of Unicode Characters"},
		{url: "https://cmake.org/Wiki/CMake", label: "CMake - KitwarePublic"},
		{url: "http://overapi.com/", label: "Collecting all the cheat sheets"},
		{url: "http://www.doxygen.nl/manual.html", label: "Doxygen"},
		{url: "http://www.gnu.org.ua/software/gdbm/", label: "GDBM"},
		{url: "https://github.com/", label: "GitHub"},
		{url: "https://tuannguyen68.gitbooks.io/learning-cmake-a-beginner-s-guide/content", label: "Learning CMake: A beginners guide"},
		{url: "https://imatix-legacy.github.io/libero/index.htm", label: "Libero Home Page"},
		{url: "https://www.riot-os.org/", label: "RIOT - The friendly Operating System for the Internet of Things"},
		{url: "http://tnerual.eriogerg.free.fr/vimqrc.html", label: "VIM Quick Reference Card"},
	],
	go: [
		{url: "programming", label: "< Programming Menu"},
		{url: "https://github.com/avelino/awesome-go", label: "Awesome Go - A curated list of awesome Go frameworks"},
		{url: "https://golang.org/", label: "The Go Programming Language"},
	],
	java: [
		{url: "programming", label: "< Programming Menu"},
	...
	web: [
		...
		{url: "http://nginx.org/en/docs/", label: "nginx documentation"},
	...
	entertainment: [
		...
		{url: "https://en.wikipedia.org/wiki/Britain%27s_Got_Talent", label: "Britain's Got Talent - Wikipedia"},
		...
		{url: "http://stthomasgunclub.com/", label: "St. Thomas Gun Club"},
		{url: "http://www.space.ca/", label: "Space"},
	...
	ebooks: [
		{url: "entertainment", label: "< Entertainment Menu"},
		{url: "fiction", label: "Fiction Menu >"},
		{url: "nonfiction", label: "Non-fiction Menu >"},
		{url: "http://www.ritmanlibrary.com/", label: "The Ritman Library - House of Living Books"},
	],
	fiction: [
		{url: "ebooks", label: "< eBooks Menu"},
		{url: "http://www.aburt.com/ifiction/stories/", label: "aburts iFiction project"},
		{url: "http://www.bookyards.com/en/welcome", label: "Bookyards.com"},
		{url: "http://www.double-dragon-ebooks.com/index.php", label: "Double Dragon Publishing"},
		{url: "http://www.feedbooks.com/", label: "Feedbooks"},
		{url: "https://www.alltimelines.com/forgotten-realms/", label: "Forgotten Realms Chronological Reading Order"},
		{url: "http://www.booksforabuck.com/general/freebook.html", label: "Free and Affordable Book Central"},
		{url: "http://www.baen.com/catalog/category/view/s/free-library/id/2012", label: "Free Library"},
		{url: "https://www.free-ebooks.net/", label: "Free-eBooks.net"},
		{url: "http://manybooks.net/", label: "ManyBooks"},
		{url: "https://www.mobileread.com/forums/forumdisplay.php?f=132", label: "Patricia Clark Memorial Library"},
		{url: "https://www.scribd.com/", label: "Scribd"},
		{url: "http://digital.library.upenn.edu/books/", label: "The Online Books Page"},
	],
	nonfiction: [
		{url: "ebooks", label: "< eBooks Menu"},
	...
	games: [
		{url: "entertainment", label: "< Entertainment Menu"},
		{url: "https://www.doomworld.com/10years/bestwads/1997.php", label: "Doomworld -- The Top 100 WADs Of All Time: 1997"},
	],
	social: [
		{url: "entertainment", label: "< Entertainment Menu"},
		{url: "https://www.facebook.com/", label: "Facebook"},
		{url: "https://www.flickr.com/", label: "Flickr"},
	...
	tv: [
		{url: "entertainment", label: "< Entertainment Menu"},
		{url: "https://gomovies.net/", label: "GoMovies"},
		{url: "https://limetorrent.cc/", label: "LimeTorrents"},
		{url: "http://megashare.ag/", label: "Megashare"},
		{url: "http://www.primewire.ag/", label: "PrimeWire"},
		{url: "http://pf-tv.co/", label: "ProjectFreeTV"},
		{url: "http://putlocker.co/", label: "Putlocker"},
		{url: "http://watchseries.do/", label: "WatchSeries"},
	],
	family: [
		{url: "main", label: "< Main Menu"},
	...
	shopping: [
		...
		{url: "http://www.sears.ca/", label: "Sears Canada"},
	...
	news: [
		{url: "main", label: "< Main Menu"},
		{url: "reddit", label: "Reddit Menu >"},
		{url: "weather", label: "Weather Menu >"},
		{url: "http://www.am980.ca/", label: "AM 980"},
		{url: "http://www.bbc.com/news", label: "BBC News"},
		{url: "http://www.cbc.ca/news", label: "CBC News"},
		{url: "http://www.ctvnews.ca/", label: "CTV News"},
		{url: "http://kitchener.ctvnews.ca/", label: "CTV News - Kitchener"},
		{url: "http://london.ctvnews.ca/", label: "CTV News - London"},
	...
	reddit: [
		{url: "news", label: "< News Menu"},
		{url: "mobile", label: "Mobile Reddit Menu >"},
		{url: "https://www.reddit.com/r/canada/", label: "Canada"},
		{url: "https://www.reddit.com/r/worldnews/", label: "World News"},
	],
	mobile: [
		{url: "reddit", label: "< Reddit Menu"},
		{url: "https://m.reddit.com/r/canada/", label: "Canada"},
		{url: "https://m.reddit.com/r/worldnews/", label: "Worldnews"},
	],
	weather: [
		{url: "news", label: "< News Menu"},
	...
	maps: [
		...
		{url: "http://cmap.city.st-thomas.on.ca/c_map/", label: "CMap"},
	...
	cloud: [
		{url: "services", label: "< Services Menu"},
		{url: "https://www.airbornos.com/", label: "Airborn OS"},
		...
		{url: "https://keep.google.com/", label: "Google Keep"},
